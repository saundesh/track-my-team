...
urlpatterns = [
    ...
    url(r'^player/teams/(?P<team_id>[0-9]+)/upload/$', views.upload_team_logo, name='upload-team-logo'),
    ...
    url(r'^player/teams/roster/create/$', views.create_roster, name='create-roster'),
    ...
    url(r'^player/teams/events/create/$', views.create_event, name='create-event'),
